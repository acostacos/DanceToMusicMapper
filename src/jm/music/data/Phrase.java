 ...
 *     Phrase leftHand = new Phrase(4.0) //start this phrase on the fifth beat
...
public class Phrase implements JMC, Cloneable, Serializable{
    ...
    * Return the tempo in beats per minute for this phrase
	...
	/**
    * Change both the duration and RhythmValue of each note in the part.
     * @param newLength The new RhythmValue for the note (length is a proportion of this value)
     */

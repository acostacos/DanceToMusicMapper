...
public class Note implements Cloneable, Serializable{
    ...
    /** default duration*/                       //JythonMusic extension
     ...
     */
    //public Note(int pitch, double duration, int dynamic, double pan){     //JythonMusic extension
    //    this(pitch, duration, dynamic, pan, duration * DEFAULT_LENGTH_MULTIPLIER);
    //}
    public Note(int pitch, double rhythmValue, int dynamic, double pan){     //JythonMusic extension
       this(pitch, rhythmValue, dynamic, pan, rhythmValue * DEFAULT_DURATION_MULTIPLIER);
    }
    /**
     * Assigns pitch and rhythmic values to the note object upon creation
     * Other values (e.g. dynamic) and given reasonable defaults
     ...
     *              representing pitch values can be found in JMC
     * @param rhythmValue 0.5 = quaver: constant values representing most
     *                    length types can be found in JMC
     * @param dynamic range is 0-127 (0 = off; 127 = loud): Constant values
     *               representing some basic dynamic types can be found in JMC
     * @param pan Specifies the balance between output channels;
     *      usually between 0 - left, and 1 - right.
     * @param duration The sounding time (in beats) of the note.
     */
    public Note(int pitch, double rhythmValue, int dynamic, double pan, double duration){
    ...
    public Note(double frequency, double rhythmValue, int dynamic, double pan){
        this(frequency, rhythmValue, dynamic, pan, rhythmValue * DEFAULT_DURATION_MULTIPLIER);
    }
     ...
     * @param duration The sounding time (in beats) of the note.
     */
    public Note(double frequency, double duration, int dynamic, double pan, double length){
    ...
    public boolean isSharp() {
        return (getName().equals("C#") || getName().equals("F#"));
    }
